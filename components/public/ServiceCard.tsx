...
export default function ServiceCard({ service, locale }: ServiceCardProps) {
  ...
  return (
    <div className="group bg-white border border-gray-100 rounded-2xl p-5 hover:border-gold/40 hover:shadow-lg transition-all duration-200 flex flex-col gap-3">
